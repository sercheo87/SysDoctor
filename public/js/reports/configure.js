...
function addDetailPatient(data,ypoint){
	...
	$.each(data.items, function (i, item) {    
		_ypoint=_ypoint+countrow;
		console.log('>>>>>>>',_ypoint);
		//etiqueta
		doc.setFontSize(12);
		doc.setFontType('bold');
		doc.text(20, _ypoint, item.etq);
		//valor
		doc.setFontSize(12);
		doc.setFontType('normal');
		doc.text(50, _ypoint, item.value);
		countrow=countrow+5;
	});
}
...
var data={
	items:[
	{etq:'Fecha:', value:'10/12/2014'},
	{etq:'Paciente:', value:'Juan Teofilo Ibarra Parrales'}
	]
};
...
doc.setFontStyle('normal');
docRow+=10;
addDetailPatient(data,docRow)

doc.setLineWidth(0.2);
doc.line(20, 255, 80, 255);
doc.setFontSize(13);
doc.text(20, 260, 'Dr. Juan Carlos');

doc.setLineWidth(0.8);
doc.line(20, 273, 190, 273);
doc.setFontSize(10);
doc.text(20, 278, 'Pichincha, Cumbaya Av el Establo y Calle C #50');
doc.text(150, 278, 'Clinica - El Trebol');
doc.text(20, 282, 'Telf. 0995982607 - 0223802920');
